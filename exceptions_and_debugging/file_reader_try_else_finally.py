...
print(read_numbers("exceptions_and_debugging/numbers.txt"))

print(read_numbers("exceptions_and_debugging/missing.txt"))

print(read_numbers("exceptions_and_debugging/bad.txt"))
